...
- `stage0_template_runbook_api/README.md`
- `stage0_template_runbook_api/docs/openapi.yaml`
- `stage0_template_runbook_api/app/main.py`
- `stage0_template_runbook_api/app/routes/*.py`

The agent may also consult:

- Existing healthcheck implementations in sibling services (if any).
- CI configuration for how tests and builds are run.
...
- Ensure the project builds successfully:
  - Example: `make build`, `npm run build`, or project‑specific equivalent.
- Run the standard test commands:
  - Example: `make test`, `pytest`, `npm test`, or project‑specific equivalent.
